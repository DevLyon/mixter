...
var UnknownSubscription = require('../../src/infrastructure/subscriptionsRepository').UnknownSubscription;
...
describe('Subscriptions Repository', function() {
    ...
    beforeEach(function(){
        ...
        repository = createSubscriptionsRepository(eventsStore);
    });
    ...
    it('Given no events When getSubscription Then throw UnknownSubscription', function() {
        ...
        }).to.throw(UnknownSubscription.caller);
    });
});