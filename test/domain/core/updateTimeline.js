...
describe('UpdateTimeline Handler', function() {
    ...
    it('When handle MessageQuacked Then save TimelineMessageProjection for author', function() {
        ...
        expect(repository.getMessageOfUser(author)).to.deep.contains(expectedProjection);
    });
    ...
    it('When handle MessageDeleted Then remove this message in TimelineMessageProjections', function() {
        ...
        var expectedProjection = timelineMessageProjection.create(author, author, messageContent, messageId);
        expect(repository.getMessageOfUser(author)).not.to.deep.contains(expectedProjection);
    });
});