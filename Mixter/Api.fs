...
let register (dto: RegisterDto) = 
    ...
    {
        Id = userIdFormatted
        Url = "/api/identity/userIdentities/" + System.Uri.EscapeDataString(userIdFormatted)
        LogIn = "/api/identity/userIdentities/" + System.Uri.EscapeDataString(userIdFormatted) + "/logIn"
    }
