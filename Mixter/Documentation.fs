module Mixter.Domain.Documentation
...
/// </summary>
type AggregateAttribute() = inherit System.Attribute()
...
/// https://en.wikipedia.org/wiki/Command%E2%80%93query_separation#Command_Query_Responsibility_Segregation
/// </summary>
type QueryAttribute() = inherit System.Attribute()
...
/// </summary>
type HandlerAttribute() = inherit System.Attribute()
...
/// </summary>
type ProjectionAttribute()= inherit System.Attribute()
...
/// </summary>
type RepositoryAttribute() = inherit System.Attribute()
...
/// </summary>
type EventAttribute() = inherit System.Attribute()
