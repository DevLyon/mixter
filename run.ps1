$languages = @{ "js"="origin/js/v2"; "csharp"="origin/csharp/v2.3";"csharp-core"="origin/csharp-core/v2"; "java"="origin/java/v2.1"; "scala"="origin/scala/v2.1"; "php"="origin/php/v2.1" }
